    ...
    <form onSubmit={handleSubmit} method='post'>
      ...
      <div className='group w-full my-1'>
        <input
          ...
          className='input input-bordered my-2 text-white input-md w-full'
        />
      </div>
      ...
      <div className='group w-full my-1'>
        <input
          ...
          name='date'
          className='input text-white input-bordered my-2 input-md w-full'
        />
      </div>
      <div className='group w-full my-1'>
        <input
      ...
      <div className='group w-full my-1'>
        <textarea
          ...
          className='textarea text-white textarea-bordered my-2 w-full'
          placeholder='Bio'
        ></textarea>
      </div>
