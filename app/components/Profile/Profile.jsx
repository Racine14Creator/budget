...
const Profile = () => {
  ...
  if (isLoading)
    return (
      <div className='absolute top-0 left-0 w-full overflow-hidden h-screen flex justify-center items-center bg-black text-white'>
        Loading...
      </div>
    );
      ...
      <div className='flex justify-between sm:flex-col sm:p-5 w-full mx-auto'>
        <div className='flex justify-between items-center p-5 rounded-full bg-white text-black shadow-md my-3'>
          <Image
            ...
            width={50}
            alt='Profile'
            className='relative w-50 h-70 rounded-full shadow-lg'
          />
