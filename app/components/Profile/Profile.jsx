...
const Profile = () => {
    ...
    if(isLoading) return <div className="absolute top-0 left-0 w-full overflow-hidden h-screen flex justify-center items-center bg-black text-white">Loading...</div>
